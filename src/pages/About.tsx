        ...
        <div className="grid md:grid-cols-3 gap-6 h-[85vh] xl:h-[75vh] 2xl:h-[70vh]">
          ...
          <div className="md:col-span-1 flex flex-col items-center justify-center text-center space-y-3 xl:space-y-4 2xl:space-y-6 bg-white/95 backdrop-blur-sm rounded-2xl p-4 xl:p-6 2xl:p-8 shadow-lg h-full">
            <div className="relative">
              <div 
                className="w-48 h-48 xl:w-56 xl:h-56 2xl:w-60 2xl:h-60 rounded-full bg-cover bg-center shadow-lg ring-4 ring-orange-200"
                style={{ backgroundImage: `url(${basePath}assets/other-assets/linkdin.jpg)` }}
              ></div>
            </div>
            
            <div>
              <h2 className="text-xl xl:text-2xl font-bold text-[#983122] mb-2">Kevin Gallagher</h2>
              <p className="text-base xl:text-lg text-[#FB8B24] font-medium mb-1">Full Stack Developer</p>
            </div>

            <div className="flex gap-4 pt-2">
              {/* GitHub Button */}  
              <a
                className="w-12 h-12 xl:w-14 xl:h-14 bg-gray-800 hover:bg-gray-900 text-white rounded-lg flex items-center justify-center transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-1"
                href='https://github.com/Gallie83/'
                target='_blank'
                rel='noopener noreferrer'
                aria-label="GitHub Profile">
                <svg className="w-6 h-6 xl:w-7 xl:h-7" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              {/* LinkedIn Button */}
              <a 
                className="w-12 h-12 xl:w-14 xl:h-14 bg-blue-600 hover:bg-blue-700 text-white rounded-lg flex items-center justify-center transition-all duration-200 shadow-md hover:shadow-lg hover:-translate-y-1"
          ...
          <div className="md:col-span-2 bg-white/95 backdrop-blur-sm rounded-2xl p-4 xl:p-6 2xl:p-8 shadow-lg space-y-4 xl:space-y-5 2xl:space-y-6 h-full overflow-y-auto">
            {/* About text */}
            <div className="space-y-3 xl:space-y-4 text-gray-700 leading-relaxed text-sm xl:text-base">
            ...
            {/* Experience */}
            <div>
              <h3 className="text-sm xl:text-base font-bold text-[#983122] mb-2 flex items-center gap-2">
                <span className="w-1 h-4 bg-[#FB8B24] rounded-full"></span>
                Experience
              </h3>
              <div className="bg-gray-50 rounded-lg p-3 xl:p-4 border border-gray-200">
                <div className="flex justify-between items-start gap-4 mb-1">
                  <div>
                    <h4 className="font-semibold text-[#983122] text-xs xl:text-sm">Full Stack Developer</h4>
            ...
            <div>
              ...
              <div className="space-y-2">
                <div className="bg-gray-50 rounded-lg p-3 xl:p-4 border border-gray-200">
                  <h4 className="font-semibold text-[#983122] text-xs xl:text-sm">AI Certification</h4>
                  <p className="text-xs text-gray-600 mt-0.5">BrainStation • Graduated April 2025</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-3 xl:p-4 border border-gray-200">
                  <h4 className="font-semibold text-[#983122] text-xs xl:text-sm">Diploma in Full-Stack Development</h4>
