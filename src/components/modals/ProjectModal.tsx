        ...
        <CardContent className="p-0 flex-1 relative">
          <div className="relative w-full h-full min-h-[500px]">
            ...
            <button
              ...
              className={`absolute left-1/2 transform -translate-x-1/2 bg-white hover:bg-gray-50 px-6 py-3 rounded-full shadow-xl border border-gray-200 transition-all duration-300 flex items-center gap-2 z-20 ${
